...
struct _ManagedCriticalState<State>: Equatable, Hashable {
  
  static func == (lhs: _ManagedCriticalState<State>, rhs: _ManagedCriticalState<State>) -> Bool {
    return lhs.buffer === rhs.buffer
  }
    
  func hash(into hasher: inout Hasher) {
    ObjectIdentifier(buffer).hash(into: &hasher)
  }
